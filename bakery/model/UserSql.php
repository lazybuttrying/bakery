...
class UserSql {
  ...
  public static $SELECT_ONE = 'SELECT u.id, u.user_id, u.user_name, u.pwd, u.email, p.pay, p.date FROM user u LEFT JOIN payment p ON u.id=p.id WHERE u.user_id=:user_id' ;
